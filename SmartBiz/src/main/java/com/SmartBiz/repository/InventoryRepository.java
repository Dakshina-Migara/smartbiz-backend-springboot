...
public interface InventoryRepository extends JpaRepository<Inventory, Long> {
        ...
        @Query("SELECT COALESCE(SUM(i.price * i.stockLevel), 0) FROM Inventory i WHERE i.business.businessId = :businessId")
        ...
        @Query("SELECT COUNT(i) FROM Inventory i WHERE i.business.businessId = :businessId AND i.stockLevel = 0")
        ...
        @Query("SELECT i FROM Inventory i WHERE i.business.businessId = :businessId AND i.stockLevel = 0")
